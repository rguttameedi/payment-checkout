...
const DEFAULT_ENV = exports.Environment.PRODUCTION;
const BFF_URLS = {
...
// API configuration
const API_BASE_URLS = {
    [exports.Environment.PRODUCTION]: getEnvVar('REACT_APP_API_URL_PRODUCTION', DEFAULT_URLS.production),
    [exports.Environment.STAGING]: getEnvVar('REACT_APP_API_URL_STAGING', DEFAULT_URLS.staging),
    [exports.Environment.LOCALDEVELOPMENT]: getEnvVar('REACT_APP_API_URL_LOCALDEVELOPMENT', DEFAULT_URLS.localdevelopment),
};
...
const OSCILAR_SCRIPT_URLS = {
    [exports.Environment.PRODUCTION]: 'https://zqp.oscilar.com/v880i7rx/loader.js',
    [exports.Environment.STAGING]: 'https://zqp-sand.oscilar.com/v880i7rx/loader.js',
    [exports.Environment.LOCALDEVELOPMENT]: 'https://zqp-sand.oscilar.com/v880i7rx/loader.js'
};
...
})(exports.MFAStatusEnum || (exports.MFAStatusEnum = {}));

exports.getApiConfig = getApiConfig;
exports.getOscilarScriptUrl = getOscilarScriptUrl;
//# sourceMappingURL=common-8ywj81H6.js.map
