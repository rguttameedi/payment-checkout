...
const PaymentDate$1 = /*@__PURE__*/ proxyCustomElement(class PaymentDate extends H {
    constructor() {
        super();
        this.__registerHost();
        this.updateDate = createEvent(this, "updateDate");
    }
    get el() { return this; }
    ...
    static get style() { return paymentDateCss; }
}, [0, "payment-date"]);
function defineCustomElement$1() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["payment-date"];
    components.forEach(tagName => { switch (tagName) {
        case "payment-date":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, PaymentDate$1);
            }
            break;
    } });
}
...
const PaymentDate = PaymentDate$1;
const defineCustomElement = defineCustomElement$1;

export { PaymentDate, defineCustomElement };
